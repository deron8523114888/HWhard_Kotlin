...
import com.example.hwhard_kolin.mvp.manu.fragment.readyExam.ReadyExamFragment
...
class ManuPagerAdapter(fm: FragmentManager) : FragmentPagerAdapter(fm, BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT) {
